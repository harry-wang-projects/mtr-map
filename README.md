...
- The TKO Line and East Rail Line have branches which require additional programming.
- For the Kwun Tong Line and Tung Chung Line, some trains terminate at stops that aren't the terminus during peak hours.
